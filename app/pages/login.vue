...
.auth-head, .auth-hero, .auth-card, .auth-perks { position: relative; }
...
@media (min-width: 1024px) {
  ...
  .auth-visual {
    ...
    padding: 0 clamp(44px, 5vw, 96px) 54px;
  }
  ...
  .auth-perks { justify-content: flex-start; margin: 0; }
  .auth-form-panel {
    min-height: 100vh;
    display: grid;
    place-items: center;
    padding: 64px clamp(40px, 6vw, 112px);
